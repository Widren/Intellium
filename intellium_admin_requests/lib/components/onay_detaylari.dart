...
import 'package:intellium_admin_requests/components/custom_buttons.dart';
          ...
          Row(
            ...
            children: [
              CustomButton(
                  onTap: () {},
                  text: 'Onayla',
                  backgroundcolor: Color.fromARGB(255, 0, 147, 252)),
              CustomButton(
                  onTap: () {},
                  text: 'Reddet',
                  backgroundcolor: Color.fromARGB(255, 255, 72, 82))
            ],
          )
        ],
      ),
